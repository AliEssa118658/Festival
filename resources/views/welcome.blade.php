...
<section class="home-banner hero-banner"  style="height:80vh">
    <img src="/images/png/square1.png?" alt="" class="scale-respo" style="position: absolute;left:0;top:48%">
...
<section class="fourth-sec" style="background-color: #FBFBFB">
    <div class="first-quote">
        <div class="container">
            ...
            <div class=" quate-text2" style="align-items: center;    padding-top: 1rem;    height: 14rem;">
               ...
               <span class="med-font"> {{__('طيب الله ثراه')}} </span></p>
            </div>
        </div>
    </div>
