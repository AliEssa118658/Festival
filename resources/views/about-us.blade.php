...
<section class="about-back" style="background-color: ">
    ...
    <div class="container py-5">
        ...
        <div class="row my-5">
            <div class="col-md-6 col-sm-12 px-0">
                <img src="images/png/light2.jpeg" class="about-img mt-3" alt="" >
                   </div>
            <div class="col-md-6 col-sm-12 ">
                <h1 class="p-text med-font3 bold  mb-2 mt-3">{{__('المرأة قوة تغيير في المجتمع')}}</h1>
        ...
        <div class="row my-5">
            ...
            <div class="col-md-6 col-sm-12  px-0">
         <img src="images/png/light3.jpeg" class="about-img" alt="" style="margin-top: 4rem" >
            </div>
        </div>
